...
# Sentinel string for the image-grid CAPTCHA challenge type. Upstream
# leaves this unimplemented in the Python port — when build_payload
# encounters it, we raise UnsupportedChallengeError so callers can fall
# back to a vision-based puzzle solver.
MP_VERIFY = "mp_verify"
