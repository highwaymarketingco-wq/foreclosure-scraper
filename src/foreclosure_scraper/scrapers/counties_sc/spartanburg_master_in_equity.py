"""Spartanburg County (SC) Master in Equity foreclosure sales."""
...
URLS = (
    "https://www.spartanburgcounty.org/278/Master-in-Equity",
    "https://www.spartanburgcounty.org/367/Sales-Roster",
    "https://www.spartanburgcounty.org/368/Sales-Information",
)
...
class SpartanburgMasterInEquity(BaseScraper):
    ...
    async def fetch(self) -> Iterable[Listing]:
        ...
        for url in URLS:
            ...
            # Some pages publish PDFs of the upcoming sales roster; capture each
            for a in tree.css("a[href$='.pdf'], a[href*='roster']"):
                href = a.attributes.get("href", "")
                if href.startswith("/"):
                    href = f"https://www.spartanburgcounty.org{href}"
                ...
                out.append(
                    Listing(
                        ...
                        state="SC",
                        county="Spartanburg",
                        description=label[:300] or "Spartanburg County Sales Roster",
                        first_seen=datetime.utcnow(),
                        last_seen=datetime.utcnow(),
                    )
                )
