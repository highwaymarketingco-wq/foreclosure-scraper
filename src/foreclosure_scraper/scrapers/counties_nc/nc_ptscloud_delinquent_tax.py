...
# X-Tenant value -> (County, State). Every tenant on this cluster is probed; the
# ones without a current delinquent export just yield 0 (Rutherford/Burke today)
# and light up automatically when their county posts a fresh extract.
...
class NCPtsCloudDelinquentTax(BaseScraper):
    ...
    name = "NC PTS Cloud Delinquent Tax Roll (Madison/Henderson/Rutherford/Burke)"
    category = "county_tax"
